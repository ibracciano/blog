...
import { createComment, deleteComment, editComment, getComments, getCommentsByPostId, likeComment } from '../controllers/comment.controller.js';
...
// route pour avoir les commentaires 
commentRouter.get('/get-comments', verifyToken, getComments);
